...
const Store = (() => {
  ...
  function _buildSearchText(lead) {
    return [
      ...
      lead.sourceSearchUrl,
      lead.sourceDataUrl,
      lead.sourceCategorySlug,
      lead.sourceCitySlug,

      // Compatibilidad con importaciones previas o payloads crudos
      lead.correo,
      lead.web_producto,
      lead.direccion,
      lead.ciudad,
      ...
      lead.pais,
      lead.perfil,
      lead.categoria_objetivo_archivo,
      lead.sub_nicho_categoria,
      lead.info_linea,
      lead.descripcion,
      lead.fuente,
      lead.ficha_url,
      lead.fuente_url_busqueda,
      lead.fuente_url_json,
      lead.categoria_slug,
      lead.ciudad_slug,

      // Campos source legacy del importador
      lead.sourceEmail,
      lead.sourceWebsite,
      lead.sourceAddress,
      lead.sourceCity,
